...
st.markdown("""
    ...
    .stTextArea textarea {
        ...
        color: #333333 !important; /* Texto oscuro dentro de las cajas */
        font-family: 'Mali', cursive;
        padding: 12px;
...
# ==========================================
# La API Key se lee directamente desde los Secrets de Streamlit
...
# --- PASO 5: RESULTADOS MÁGICOS ---
    ...
    with st.spinner("Invocando a la IA del amor... 🐱✨"):
        try:
            ...
            # Formatear las respuestas para el prompt (Usando str(i) para evitar el error '0')
